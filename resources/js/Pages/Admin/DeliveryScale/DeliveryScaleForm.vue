...
const url = deliveryScale
    ? route('admin.delivery-scales.update', deliveryScale.id)
    : route('admin.delivery-scales.store');
...
<template>
    <PageHeader>
        ...
        <template #actions>
            <LinkButton :href="route('admin.delivery-scales.index')"
                >Back</LinkButton
            >
        </template>
    </PageHeader>
    ...
    <Card class="mx-auto mt-6 p-4">
        <form @submit.prevent="submitForm">
            ...
            <div class="flex gap-2">
                ...
                <LinkButton
                    :href="route('admin.delivery-scales.index')"
                    color="danger"
                >
                    Cancel
                </LinkButton>
