    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">
                ...
                {{ route.params.id ? 'existing' : 'new' }} purchase.
            </p>
        </div>
        <LinkButton :to="{ name: 'purchase-return.index' }">Back</LinkButton>
    </div>
    <form @submit.prevent="submitForm">
                    ...
                    <TableRow v-for="(item, index) in form.items" :key="index">
                        <TableCell class="px-1">
                            <SelectInput
                                ...
                                @change="
                                    changeItemType(item.item_type, item, index)
                                "
                            />
                        </TableCell>
                        <TableCell class="px-1">
        ...
        <Card class="mx-auto mt-6">
            <div class="flex flex-wrap gap-3">
                ...
                <LinkButton :to="{ name: 'purchase-return.index' }" color="red"
                    >Cancel</LinkButton
                >
            </div>
        </Card>
