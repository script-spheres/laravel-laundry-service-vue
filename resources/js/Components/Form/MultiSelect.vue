                ...
                <div class="relative z-20 inline-block w-full">
                    <div class="relative flex flex-col items-center">
                        <div @click="open" class="w-full">
                            <div
                                class="border-stroke focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input mb-2 flex rounded border py-2 pl-3 pr-3 outline-none transition"
                            >
                                <div class="flex flex-auto flex-wrap gap-3">
                                    ...
                                    >
                                        <div
                                            class="border-stroke bg-gray dark:border-strokedark my-1.5 flex items-center justify-center rounded border-[.5px] px-2.5 py-1.5 text-sm font-medium dark:bg-white/30"
                                        >
                                            <div
                                            ...
                                            >
                                                <div
                                                    @click="remove(index)"
                                                    class="hover:text-danger cursor-pointer pl-2"
                                                >
                                                    <svg
                                                        class="fill-current"
                                                        role="button"
                                    ...
                                    >
                                        <input
                                            ...
                                            class="h-full w-full appearance-none border-none bg-transparent p-1 px-2 outline-none"
                        ...
                        <div class="w-full px-4">
                            <div
                                v-show="isOpen()"
                                ref="target"
                                class="max-h-select dark:bg-form-input absolute left-0 top-full z-40 w-full overflow-y-auto rounded bg-white shadow"
                            >
                                <div class="flex w-full flex-col">
                                    ...
                                    >
                                        <div
                                            ...
                                            class="border-stroke hover:bg-primary/5 dark:border-form-strokedark w-full cursor-pointer rounded-t border-b"
                                        >
                                            <div
                                                :class="[
