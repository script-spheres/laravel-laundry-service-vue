...
class StoreController extends Controller
{
    ...
    {
        return Inertia::render('Store/StoreForm');
    }
    ...
    public function store(StoreStoreRequest $request, StoreService $storeService)
    {
        ...
        return redirect()->route('stores.index')->with(['message' => 'Created successfully']);
    }
    ...
    public function update(UpdateStoreRequest $request, Store $store, StoreService $storeService)
    {
        ...
        return redirect()->route('stores.index')->with(['message' => 'Updated successfully']);
    }
